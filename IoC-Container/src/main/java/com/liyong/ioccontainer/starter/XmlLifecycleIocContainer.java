 ...
 *
**/
public class XmlLifecycleIocContainer {

    public static void main(String[] args) throws InterruptedException {

        String xmlResourcePath = "classpath:/META-INF/lifecycle-metadata.xml";
        ...
        //lifecycleService.stop(()-> System.out.println("async call"));
