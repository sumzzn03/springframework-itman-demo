 ...
 *
 **/
public class XmlDependOnSpaceIocContainer {
    ...
    public static void main(String[] args) {
        ...
        String xmlResourcePath = "classpath:/META-INF/dependon-metadata.xml";

        // 加载 XML 资源，解析并且生成 BeanDefinition
        beanDefinitionReader.loadBeanDefinitions(xmlResourcePath);

        // 依赖查找并且创建 Bean
        DependOnService dependOnService = beanFactory.getBean(DependOnService.class);
