 ...
 *@version v1.0.0
 *@className TransactionTemplates使用
 *@description
 *@JunitTest: {@link  }
 *@date 12:22 AM 2020/5/7
 *
 **/
public class TransactionTemplateIocContainer {

    public static void main(String[] args) {

        String xmlResourcePath = "classpath:/META-INF/transaction-template-metadata.xml";

        // 创建 BeanFactory 容器
        AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext();
        // 注册 Configuration Class（配置类） -> Spring Bean
        applicationContext.register(TransactionTemplateIocContainer.class);
